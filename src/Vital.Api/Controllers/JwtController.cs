...
namespace Vital.Api.Controllers
{
    ...
    public class JwtController : Controller
    {
        ...
        private static Task<ClaimsIdentity> GetClaimsIdentity(User user)
        {
            ...
            {
                return
                    Task.FromResult(new ClaimsIdentity(new GenericIdentity(user.UserName, "Token"),
                        new[] {new Claim("Mode", "God")}));
            }

            if (user.UserName == "adminnogod" &&
                user.Password == "admin")
            {
